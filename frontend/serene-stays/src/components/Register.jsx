...
<div className="flex flex-col justify-center">
                ...
                <div className="flex justify-center">
                    ...
                    <input onChange={(e)=>setName(e.target.value)} className="border border-gray-300 rounded-md py-2 mb-3 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500" />
     ...
     try{
        const result=await axios.post("http://localhost:3000/api/auth/register",information);
        navigate("/")
